...
export function MidPointLineAlgorithm(color_buffer, x0, y0, x1, y1, color_0, color_1) {
...
export function DrawTriangle(color_buffer, x0, y0, x1, y1, x2, y2, color_0, color_1, color_2) {
